...
\affiliation{\institution{VaidhyaMegha Private Limited}\country{India}}
...
Rust~\cite{mandarapu2026samyama} with OpenCypher support (${\sim}$90\%
...
late materialization~\cite{mandarapu2026samyama}, so memory
...
\bibitem{mandarapu2026samyama}
M.~Mandarapu and S.~Kunkunuru.
\newblock Samyama: A unified graph-vector database with in-database optimization,
  agentic enrichment, and hardware acceleration.
\newblock {\em arXiv:2603.08036}, 2026.
