...
Samyama, Neo4j runs the subset in \textbf{8.1~s} vs.\ Samyama's
\textbf{35.6~s} (4.4$\times$ faster overall) on this 8M-node graph,
winning 38/38 plain-shape queries and 10/17 adjacency-aware
aggregation queries.  Samyama wins one adj-agg query and ties on
six.  The plain-shape gap is dominated by Samyama's per-query SDK
overhead (45--85~ms vs.\ Neo4j's 1--3~ms via Bolt) rather than
planner or executor cost.
