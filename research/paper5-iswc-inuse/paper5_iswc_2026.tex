...
passes, 32~documented corpus-coverage gaps), runs on a single
\$1.50/hr AWS spot instance, and has been in continuous use for
biomedical analytics since late 2025.  We discuss the design
trade-offs, limitations, and failure modes encountered during
deployment.
...
Samyama, a graph database used since late 2025 for federated
biomedical knowledge graph analytics.  Our contributions are
empirical findings from building and operating this system:
...
The system has been in continuous use since November 2025 for
internal biomedical analytics and collaboration with research
partners.  Two deployment configurations are maintained:
