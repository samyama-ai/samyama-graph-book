...
\paragraph{Model comparison.} The baseline used GPT-4; we evaluated with both GPT-4 and GPT-4o to isolate the graph's contribution. GPT-4 NLQ achieves 82\% (114/139); GPT-4o NLQ achieves 83\% (115/139). The near-identical results confirm that the +17 percentage point improvement over the baseline (65\%) is attributable to the knowledge graph, not the model upgrade.
